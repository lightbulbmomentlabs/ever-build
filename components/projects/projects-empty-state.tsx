 ...
 *
 * Mini version of dashboard empty state for the projects page.
    ...
    <div className="rounded-lg border bg-white p-8 md:p-12 shadow-sm">
      <div className="flex flex-col items-center justify-center text-center max-w-2xl mx-auto">
        ...
        <p className="text-sm md:text-base text-steel-gray leading-relaxed mb-6">
          Ready to get started? Create your first project to begin tracking your spec home
          or custom build from lot acquisition to final walkthrough.
        </p>
